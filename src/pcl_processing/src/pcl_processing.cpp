...
class PclProcessing : public rclcpp::Node
{
  public:
    ...
    : Node("pcl_processing")
    {
      ...
      "/zed2/zed_node/point_cloud/cloud_registered", 10, std::bind(&PclProcessing::topic_callback, this, std::placeholders::_1));
  ...
  private:
    void topic_callback(const sensor_msgs::msg::PointCloud2::SharedPtr msg) const
    {
        ...
        iter_x != iter_x.end(); ++iter_x, ++iter_y, ++iter_z)
      {
        ...
        // RCLCPP_INFO(this->get_logger(), "coord of point is x %f y %f", *iter_x, *iter_y);
      ...
      // RCLCPP_INFO(this->get_logger(), "coord of bound point is x %f y %f", min_x, min_y);
      closest_point.x = min_x;
      closest_point.y = min_y;
      if (!(min_y >= INT_MAX && min_x >= INT_MAX))
      {
        RCLCPP_INFO(this->get_logger(), "coord of bound point is x %f y %f", min_x, min_y);
